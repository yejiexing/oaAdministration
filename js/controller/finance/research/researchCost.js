...
app.controller('researchCtrl',function($http, $scope, $timeout) {
    var self = this;
        ...
        $http({
            ...
            if(data.code == 200) {
                ...
                if(params == 1){
                    ...
                    function getValue(arr, v){
                        var tmpData = {};
                        for(var key in arr){
                            if(arr[key].id == v || arr[key].name == v){            
                                tmpData ={
                                    id : arr[key].id,
                                    name: arr[key].name
                                }
                    ...
                    var result = getValue($scope.chooseTypeList, $scope.copyapplicationArr.type);
                    $scope.copyapplicationArr.type = result.name;
