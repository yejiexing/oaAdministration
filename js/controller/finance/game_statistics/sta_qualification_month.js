 ...
 */
var app = angular.module('statisticsQualificationMonth', []);
app.controller('statisticsQualificationMonthCtrl', function($http, $scope) {
    var self = this;
    ...
    if (!state) {
        ...
        $scope.isexport = parents.authList('expensestatistics-exportqualificationmonthcount');//导出操作
    }
    $('#query').show();
