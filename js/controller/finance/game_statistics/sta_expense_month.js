 ...
 */
var app = angular.module('statisticsExpenseMonth', []);
app.controller('statisticsExpenseMonthCtrl', function($http, $scope) {
    var self = this;
    ...
    if (!state) {
        ...
        $scope.isexport = parents.authList('expensestatistics-exportmonthcount');//导出操作
    }
    $('#query').show();
