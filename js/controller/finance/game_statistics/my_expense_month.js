 ...
 */
var app = angular.module('myStatisticsExpenseMonth', []);
app.controller('myStatisticsExpenseMonthCtrl', function($http, $scope) {
    var self = this;
    ...
    if (!state) {
        ...
        $scope.isexport = parents.authList('myexpensestatistics-exportmonthcount');//导出操作
    }
    $('#query').show();
    ...
    $scope.export = function() {
        ...
        parents.Exports('expense_statistics/exportMonthCount', ExpObj);
    };
    ...
    function initTable() {
        $('#demo-table').bootstrapTable({
            ...
            url: url + 'admin/expense_statistics/getMonthCount',
            height: 670,
            showColumns: false,
            pagination: true,
            showRefresh: false,
    ...
    $scope.stateedit = function(v) {
        ...
        $http({
            ...
            url:
                url +
                'admin/expense_statistics/getMonthCount/' +
