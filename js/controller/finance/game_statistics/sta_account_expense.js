 ...
 */
var app = angular.module('getAccountDay', []);
app.controller('getAccountDayCtrl', function($http, $scope) {
    var self = this;
    ...
    if (!state) {
        ...
        $scope.isexport = parents.authList('expensestatistics-exportaccountdaycount');//导出操作
    }
    $('#query').show();
