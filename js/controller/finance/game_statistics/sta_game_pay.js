 ...
 */
var app = angular.module('statisticsGameDay', []);
app.controller('statisticsGameDayCtrl', function($http, $scope) {
    var self = this;
    ...
    if (!state) {
        ...
        $scope.isexport = parents.authList('expensestatistics-exportgamedaycount');//导出操作
    }
    $('#query').show();
