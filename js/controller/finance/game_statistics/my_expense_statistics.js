 ...
 */
var app = angular.module('myExpenseStatistics', []);
app.controller('myExpenseStatisticsCtrl', function($http, $scope) {
    var self = this;
    ...
    if (!state) {
        ...
        $scope.isexport = parents.authList('myexpensestatistics-exportactivitydaycount');//导出操作
    }
    $('#query').show();
