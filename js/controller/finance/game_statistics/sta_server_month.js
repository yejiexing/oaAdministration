 ...
 */
var app = angular.module('statisticsServerMonth', []);
app.controller('statisticsServerMonthCtrl', function($http, $scope) {
    var self = this;
    ...
    if (!state) {
        ...
        $scope.isexport = parents.authList('expensestatistics-exportservermonthcount');//导出操作
    }
    $('#query').show();
