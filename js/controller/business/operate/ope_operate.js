 ...
 */
var app = angular.module('opeOperate',[]);
app.controller('opeOperateCtrl',function($http, $scope, $timeout) {
    var self = this;
    ...
    $scope.preservaConfirm = function(){//新增弹出框
        ...
        angular.forEach($scope.copyoperateArr,function(v,i){
            if(i == 'date' || i == 'project' || i == 'product' || i == 'channel' || i == 'new_arrivals' || i == 'active_users') {
                if (v == '') {
                    channelNum++
                }
            }
